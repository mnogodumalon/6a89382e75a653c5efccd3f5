// Auto-generated. Per-entity form-enhancements config for "Leihvorgänge".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ["leihrad", "kunde", {"row": ["startdatum", "enddatum"]}, "bild_vorher", "zustand_vorher", "bild_nachher", "zustand_nachher", "status"],
  defaults: {},
  computed: {},
};
